...
export class HistoryListComponent implements OnInit {
  ...
  getIcon(action: string): string {
    ...
    if (action.includes('IMPORT') || action.includes('SUBMIT') || action.includes('REGISTER')) return 'cloud_upload';
    if (action.includes('REVIEW')) return 'rate_review';
    return 'history';
  }

  getBgColor(action: string): string {
    if (action.includes('CREATE') || action.includes('IMPORT') || action.includes('SUBMIT') || action.includes('REGISTER')) return 'bg-green-50';
  ...
  getIconColor(action: string): string {
    if (action.includes('CREATE') || action.includes('IMPORT') || action.includes('SUBMIT') || action.includes('REGISTER')) return 'text-green-600';
  ...
  getBadgeStyles(action: string): string {
    if (action.includes('CREATE') || action.includes('IMPORT') || action.includes('SUBMIT') || action.includes('REGISTER')) return 'bg-green-50 text-green-700 border-green-200';
