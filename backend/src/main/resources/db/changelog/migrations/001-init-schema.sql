...
CREATE TABLE thesis_batches (
    ...
    topic_reg_start         TIMESTAMPTZ NOT NULL,
    topic_reg_end           TIMESTAMPTZ NOT NULL,
    outline_start           TIMESTAMPTZ NOT NULL,
    outline_end             TIMESTAMPTZ NOT NULL,
    implementation_start    TIMESTAMPTZ NOT NULL,
    implementation_end      TIMESTAMPTZ NOT NULL,
    defense_reg_start       TIMESTAMPTZ NOT NULL,
    defense_reg_end         TIMESTAMPTZ NOT NULL,
